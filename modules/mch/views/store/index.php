...
<div class="row home-row" id="app" style="display: none">
                ...
                <div class="row">
                    <div class="col-4 panel-2-item" flex="cross:center main:center">
                        <div flex="dir:left box:last" class="w-100">
                            ...
                            <div style="width: 100px;text-align: center" class="url-to" 
                                 onclick="window.location.href=`<?= $urlManager->createUrl(['mch/goods/goods']) ?>`;return false">
                    ...
                    <div class="col-4 panel-2-item" flex="cross:center main:center">
                        <div flex="dir:left box:last" class="w-100">
                            ...
                            <div style="width: 100px;text-align: center" class="url-to" 
                                 onclick="window.location.href=`<?= $urlManager->createUrl(['mch/order/index', 'status' => 1]) ?>`;return false">
                    ...
                    <div class="col-4 panel-2-item" flex="cross:center main:center">
                        <div flex="dir:left box:last" class="w-100">
                            ...
                            <div style="width: 100px;text-align: center" class="url-to" 
                                 onclick="window.location.href=`<?= $urlManager->createUrl(['mch/order/refund', 'status' => 0]) ?>`;return false">
                                <div style="font-size: 1.75rem">
                                    {{panel_2.order_refunding_count}}
                                </div>
                                <div>维权中订单</div>
                            </div>
                        </div>
    ...
    <div class="home-col col-md-6">
        ...
        <div class="panel panel-3 mb-3" v-if="panel_3">
            ...
            <div class="panel-body">
                <div id="echarts_3" style="height:17rem;"></div>
            </div>
        </div>
...
<script>
    ...
    echarts3 = function(){
            var echarts_3 = echarts.init(document.getElementById('echarts_3'));
            let count = app.panel_3.data_1.order_goods_count;
            let average = app.panel_3.data_1.order_price_average;
            let price = app.panel_3.data_1.order_price_count;
            setTimeout(function () {

...
<div class="panel mb-3" id="app">
    ...
    <div class="panel-body">
        <form class="auto-form" method="post">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label required">价格</label>
                </div>
                <div class="col-sm-6">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr v-for="attr_row in goods.attr">
                                ...
                                <td><input style="width: 4rem" type="number"
                                           ...
                                           v-model="attr_row.dingshi_price"
                                           step="0.01" min="0.01"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= $urlManager->createUrl(['mch/dingshi/goods-search']) ?>"
...
<script>
    ...
    $(document).on("click", ".miaosha-submit-btn", function () {
        if (!app.goods || app.open_date.length == 0) {
            $.myToast({
                content: "请完善秒杀商品信息",
            });
            return;

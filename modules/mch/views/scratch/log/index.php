        ...
        <table class="table table-bordered bg-white">
            ...
            <?php foreach ($list as $index => $item): ?>
                <tr>
                    ...
                    <td classs="nowrap">
                            <?php if ($item->status == 0): ?><span class="badge badge-primary"  style="font-size: 100%;">预领取</span><?php endif; ?>
                        <?php if($item->type!=5):?>
                            <?php if ($item->status == 1): ?><span class="badge badge-warning"  style="font-size: 100%;">未兑换</span><?php endif; ?>
                            <?php if ($item->status == 2): ?><span class="badge badge-success"  style="font-size: 100%;">已兑换</span><?php endif; ?>
                        <?php endif?>
                    </td>
                    <td class="nowrap">

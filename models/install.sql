...
CREATE TABLE `hjmall_action_log`  (
  ...
  `title` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作记录描述',
  `addtime` int(11) NOT NULL COMMENT '记录时间',
  `admin_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作人姓名',
  `admin_id` int(11) NOT NULL COMMENT '操作人ID',
  `admin_ip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作人IP地址',
  `route` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作路由',
  `action_type` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '操作类型',
  `obj_id` int(11) NOT NULL COMMENT '操作数据ID',
  `result` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '操作结果',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户收货地址' ROW_FORMAT = Compact;
...
-- ----------------------------
-- Records of hjmall_admin_permission
-- ----------------------------
INSERT INTO `hjmall_admin_permission` VALUES (1, 'coupon', '优惠券', 0, 1000);
INSERT INTO `hjmall_admin_permission` VALUES (2, 'share', '分销', 0, 1000);
INSERT INTO `hjmall_admin_permission` VALUES (3, 'topic', '专题', 0, 1000);
INSERT INTO `hjmall_admin_permission` VALUES (4, 'video', '视频专区', 0, 1000);
...
CREATE TABLE `hjmall_admin_register`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '帐户名',
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码',
  `mobile` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手机号',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '姓名/企业名',
  `desc` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '申请原因',
...
CREATE TABLE `hjmall_article`  (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统文章' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_attr_group`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  `attr_group_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品规格组' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_banner`  (
  ...
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片url',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `page_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '页面路径',
  `sort` int(11) NOT NULL DEFAULT 100 COMMENT '排序，升序',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商店幻灯片' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_bargain_order`  (
  ...
  `is_delete` int(11) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  `attr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `status_data` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '砍价方式数据',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `store_id`(`store_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
...
CREATE TABLE `hjmall_bargain_setting`  (
  ...
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '活动规则',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '砍价插件用户砍价情况；' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_card`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡券名称',
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '卡券图片',
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '卡券描述',
...
CREATE TABLE `hjmall_cash`  (
  ...
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付宝账号',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付宝姓名',
  `bank_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '开户行名称',
  `pay_type` int(11) NULL DEFAULT 0 COMMENT '打款方式 0--之前未统计的 1--微信自动打款 2--手动打款',
  `order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信自动打款订单号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
...
CREATE TABLE `hjmall_cat`  (
  ...
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分类图片url',
  `sort` int(11) NOT NULL DEFAULT 100 COMMENT '排序，升序',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `big_pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '分类大图',
  `advert_pic` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '广告图片',
  `advert_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '广告链接',
...
CREATE TABLE `hjmall_color`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rgb` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'rgb颜色码 例如：\"0，0，0\"',
  `color` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '16进制颜色码例如：#ffffff',
  `is_delete` int(11) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '颜色库' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of hjmall_color
-- ----------------------------
...
CREATE TABLE `hjmall_coupon`  (
  ...
  `desc` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `pic_url` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  `cat_id_list` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `appoint_type` tinyint(1) NULL DEFAULT NULL,
  ...
  `goods_id_list` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `store_id`(`store_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_coupon_auto_send`  (
  ...
  `is_delete` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券自动发放' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_delivery`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `express_id` int(11) NULL DEFAULT NULL COMMENT '快递公司id',
  `customer_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电子面单客户账号',
  `customer_pwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电子面单密码',
  `month_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '月结编码',
  `send_site` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网点编码',
  `send_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网点名称',
  `is_delete` smallint(2) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_express`  (
  ...
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '数据类型：kdniao=快递鸟',
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 103 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '快递公司' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of hjmall_express
-- ----------------------------
...
CREATE TABLE `hjmall_favorite`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '我喜欢的商品' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_file_group`  (
  ...
  `is_default` int(11) NULL DEFAULT 0 COMMENT '是否可编辑',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图片库分组' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_form`  (
  ...
  `required` int(11) NULL DEFAULT NULL COMMENT '必填项',
  `default` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '默认值',
  `tip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提示语',
...
CREATE TABLE `hjmall_form_id`  (
  ...
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小程序form_id和prepay_id记录' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_fxhb_hongbao`  (
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `form_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '小程序form_id',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_fxhb_setting`  (
  ...
  `tpl_msg_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '红包到账通知模板消息id',
  ...
  `rule` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '规则',
  `share_pic` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `share_title` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_goods`  (
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `attr` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '规格的库存及价格',
  `service` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '商品服务选项',
  ...
  `unit` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '件' COMMENT '单位',
  ...
  `weight` double(10, 2) UNSIGNED NULL DEFAULT 0.00 COMMENT '重量',
  `freight` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '运费模板ID',
  `full_cut` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '满减',
  `integral` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '积分设置',
  `use_attr` smallint(1) NOT NULL DEFAULT 1 COMMENT '是否使用规格：0=不使用，1=使用',
  `share_type` int(11) NULL DEFAULT 0 COMMENT '佣金配比 0--百分比 1--固定金额',
  `quick_purchase` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否加入快速购买  0--关闭   1--开启',
  `hot_cakes` smallint(1) NULL DEFAULT NULL COMMENT '是否加入热销  0--关闭   1--开启',
  `cost_price` decimal(10, 2) NULL DEFAULT 0.00,
  `member_discount` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否参与会员折扣  0=参与   1=不参与',
  `rebate` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '自购返利',
...
CREATE TABLE `hjmall_goods_pic`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT 0,
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `goods_id`(`goods_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_goods_share`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `type` int(11) NULL DEFAULT 0 COMMENT '商品类型 0--拼团',
  ...
  `rebate` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '自购返利',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品分销设置；' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_home_block`  (
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `style` int(11) NULL DEFAULT 0 COMMENT '板块样式 0--默认样式 1--样式一 2--样式二 。。。',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页自定义版块' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_home_nav`  (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页导航图标' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_in_order_comment`  (
  ...
  `pic_list` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '图片',
  `is_hide` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否隐藏：0=不隐藏，1=隐藏',
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  `reply_content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  `is_virtual` smallint(6) NOT NULL DEFAULT 0,
  `virtual_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  `virtual_avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_integral_goods`  (
  ...
  `goods_pic_list` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `hjmall_integral_log`  (
  ...
  `operator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '操作者',
  `store_id` int(11) UNSIGNED NOT NULL,
  `operator_id` int(11) UNSIGNED NOT NULL COMMENT '分销商id',
  `type` int(11) NOT NULL DEFAULT 0 COMMENT '数据类型 0--积分修改 1--余额修改',
  `pic_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `explain` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_integral_order`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '收货人姓名',
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '收货人手机',
  `address` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '收货地址',
  `remark` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '订单备注',
  ...
  `express` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '物流公司',
  `express_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `address_data` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '收货地址信息，json格式',
  ...
  `offline_qrcode` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '核销码',
  `shop_id` int(11) NOT NULL DEFAULT -1 COMMENT '自提门店ID',
  `is_sale` int(11) NOT NULL DEFAULT 0 COMMENT '是否超过售后时间',
  `version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '版本',
  `mch_id` int(11) NOT NULL DEFAULT 0 COMMENT '入驻商户id',
  `integral` int(11) NOT NULL COMMENT '花费的积分',
  `goods_id` int(11) NOT NULL,
  `words` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商家留言',
...
CREATE TABLE `hjmall_integral_order_detail`  (
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `attr` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品规格',
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品规格图片',
...
CREATE TABLE `hjmall_integral_setting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  `integral_shuoming` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '积分说明',
  `register_rule` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '签到规则',
  `register_integral` int(11) NOT NULL COMMENT '每日签到获得分数',
  `register_continuation` int(11) NOT NULL COMMENT '连续签到天数',
  `register_reward` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '连续签到奖励',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_level`  (
  ...
  `money` decimal(10, 2) NULL DEFAULT NULL COMMENT '会员完成订单金额满足则升级',
  `discount` decimal(10, 1) NULL DEFAULT NULL COMMENT '折扣',
  `status` int(11) NULL DEFAULT NULL COMMENT '状态 0--禁用 1--启用',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `image` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '会员图片',
  `price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '会员价格',
  `detail` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '会员介绍',
  `buy_prompt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '购买之前提示',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `hjmall_level_order`  (
  ...
  `pay_type` int(11) NULL DEFAULT 0 COMMENT '支付方式 1--微信支付',
  `is_pay` int(11) NULL DEFAULT 0 COMMENT '是否支付 0--未支付 1--支付',
  `pay_time` int(11) NULL DEFAULT NULL COMMENT '支付时间',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `current_level` int(11) NULL DEFAULT NULL,
  `after_level` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mail_setting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `send_mail` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '发件人邮箱',
  `send_pwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '授权码',
  `send_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件人名称',
  `receive_mail` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '收件人邮箱 多个用英文逗号隔开',
  `status` int(11) NULL DEFAULT NULL COMMENT '是否开启邮件通知 0--关闭 1--开启',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch`  (
  ...
  `review_result` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '审核结果',
  ...
  `service_tel` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '客服电话',
  `logo` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'logo',
  `header_bg` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '背景图',
  `transfer_rate` int(11) NOT NULL DEFAULT 0 COMMENT '商户手续费',
  `account_money` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '商户余额',
  `sort` int(11) NOT NULL DEFAULT 1000 COMMENT '排序：升序',
  `wechat_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '微信号',
  `is_recommend` int(11) NOT NULL DEFAULT 1 COMMENT '好店推荐：0.不推荐|1.推荐',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_account_log`  (
  ...
  `addtime` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '入驻商户账户收支记录' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_cash`  (
  ...
  `type_data` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '不同提现类型，提交的数据',
  `virtual_type` smallint(6) NOT NULL DEFAULT 0 COMMENT '实际上打款方式',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户提现记录' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_cat`  (
  ...
  `icon` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '分类图标',
  `sort` int(11) NOT NULL DEFAULT 1000,
  `is_delete` tinyint(1) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '入驻商商品分类' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_goods_cat`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '入驻商商品分类关系' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_plugin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户权限表' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_postage_rules`  (
  ...
  `detail` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '规则详细',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_enable` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否启用：0=否，1=是',
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `express` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '快递公司',
  `type` smallint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '计费方式【1=>按重计费、2=>按件计费】',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '入驻商运费规则' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_mch_setting`  (
  ...
  `is_share` smallint(6) NOT NULL DEFAULT 0 COMMENT '是否开启分销 0--不开启 1--开启',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_miaosha`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  `open_time` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '开放时间，JSON格式',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_miaosha_goods`  (
  ...
  `attr` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '规格秒杀价数量',
  `is_delete` smallint(6) NOT NULL DEFAULT 0,
...
CREATE TABLE `hjmall_ms_goods`  (
  ...
  `service` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '服务选项',
  `sort` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '商品排序 升序',
  ...
  `sales` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '实际销量',
  `store_id` int(11) UNSIGNED NOT NULL,
  `video_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '视频',
  `unit` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '件' COMMENT '单位',
  `weight` double(10, 2) UNSIGNED NULL DEFAULT 0.00 COMMENT '重量',
  ...
  `payment` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '支付方式',
  `individual_share` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否单独分销设置：0=否，1=是',
  `share_commission_first` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '一级分销佣金比例',
  `share_commission_second` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '二级分销佣金比例',
  `share_commission_third` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '三级分销佣金比例',
...
CREATE TABLE `hjmall_ms_order`  (
  ...
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收货人手机',
  ...
  `clerk_id` int(11) NULL DEFAULT NULL COMMENT '核销员user_id',
  `is_cancel` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否取消',
  `offline_qrcode` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '核销码',
  `before_update_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '修改前的价格',
  `shop_id` int(11) NULL DEFAULT NULL COMMENT '自提门店ID',
  `discount` decimal(11, 2) NULL DEFAULT NULL COMMENT '会员折扣',
  `user_coupon_id` int(11) NULL DEFAULT NULL COMMENT '使用的优惠券ID',
  `integral` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '积分使用',
  `give_integral` smallint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否发放积分【1=> 已发放 ， 0=> 未发放】',
  `parent_id_1` int(11) NULL DEFAULT NULL COMMENT '用户上二级ID',
  `parent_id_2` int(11) NULL DEFAULT NULL COMMENT '用户上三级ID',
  `is_sale` int(11) NULL DEFAULT 0 COMMENT '是否超过售后时间',
  `words` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商家留言',
  `express_price_1` decimal(10, 2) NULL DEFAULT NULL COMMENT '减免的运费',
  `goods_id` int(11) NOT NULL,
  `attr` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品规格',
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品规格图片',
  ...
  `is_sum` smallint(1) NULL DEFAULT 0 COMMENT '是否计算分销 0--不计算 1--计算',
  `rebate` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '自购返利',
  `before_update_express` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '价格修改前的运费',
...
CREATE TABLE `hjmall_ms_order_comment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀订单评价表' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_ms_order_refund`  (
  ...
  `pic_list` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '凭证图片列表：json格式',
...
CREATE TABLE `hjmall_ms_setting`  (
  ...
  `is_share` int(11) NULL DEFAULT 0 COMMENT '是否开启分销 0--关闭 1--开启',
  `is_sms` int(11) NULL DEFAULT 0 COMMENT '是否开启短信通知',
  `is_print` int(11) NULL DEFAULT 0 COMMENT '是否开启订单打印',
  `is_mail` int(11) NULL DEFAULT 0 COMMENT '是否开启邮件通知',
  `is_area` tinyint(1) NULL DEFAULT NULL COMMENT '区域限制  1-开启 0-关闭',
...
CREATE TABLE `hjmall_order`  (
  ...
  `integral` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '积分使用',
  `give_integral` smallint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否发放积分【1=> 已发放 ， 0=> 未发放】',
  `parent_id_1` int(11) NULL DEFAULT 0 COMMENT '用户上二级ID',
  `parent_id_2` int(11) NULL DEFAULT 0 COMMENT '用户上三级ID',
  `is_sale` int(11) NULL DEFAULT 0 COMMENT '是否超过售后时间',
  `words` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商家留言',
  `version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '版本',
  `express_price_1` decimal(10, 2) NULL DEFAULT NULL COMMENT '减免的运费',
  `is_recycle` smallint(1) NULL DEFAULT 0,
  `rebate` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '自购返利',
  `before_update_express` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '价格修改前的运费',
  `seller_comments` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商家备注',
  `mch_id` int(11) NOT NULL DEFAULT 0 COMMENT '入驻商户id',
  ...
  `type` int(11) NULL DEFAULT 0 COMMENT '0:普通订单 1大转盘订单',
  `share_price` decimal(11, 2) NULL DEFAULT 0.00 COMMENT '发放佣金的金额',
...
CREATE TABLE `hjmall_order_comment`  (
  ...
  `is_virtual` smallint(6) NULL DEFAULT NULL,
  `virtual_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `virtual_avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `hjmall_order_detail`  (
  ...
  INDEX `goods_id`(`goods_id`) USING BTREE,
  INDEX `addtime`(`addtime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单明细' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_order_express`  (
  ...
  `is_delete` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单电子面单记录' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_order_form`  (
  ...
  `store_id` int(11) NULL DEFAULT NULL,
  `order_id` int(11) NULL DEFAULT NULL,
  `key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '表单key',
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '表单value',
  `is_delete` int(11) NULL DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '表单信息类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单自定义表单信息' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_order_message`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `order_id` int(11) NULL DEFAULT NULL COMMENT '类型id 系统消息时为0',
  `is_read` int(11) NULL DEFAULT NULL COMMENT '消息是否已读 0--未读 1--已读',
  `is_sound` int(11) NULL DEFAULT NULL COMMENT '是否提示 0--未提示  1--已提示',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `type` smallint(1) NULL DEFAULT 0 COMMENT '订单类型  0--已下订单   1--售后订单',
  `order_type` int(11) NULL DEFAULT 0 COMMENT '订单类型 0--商城订单 1--秒杀订单 2--拼团订单 3--预约订单',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_order_refund`  (
  ...
  `order_id` int(11) NOT NULL,
  `order_detail_id` int(11) NOT NULL,
  `order_refund_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '退款单号',
  `type` smallint(6) NOT NULL DEFAULT 1 COMMENT '售后类型：1=退货退款，2=换货',
  `refund_price` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '退款金额',
  `desc` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '退款说明',
  `pic_list` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '凭证图片列表：json格式',
  `status` smallint(1) NOT NULL DEFAULT 0 COMMENT '状态：0=待商家处理，1=同意并已退款，2=已同意换货，3=已拒绝退换货',
  `refuse_desc` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '拒绝退换货原因',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `response_time` int(11) NOT NULL DEFAULT 0 COMMENT '商家处理时间',
  ...
  `user_send_express` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户发货快递公司',
  `user_send_express_no` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户发货快递单号',
  `address_id` int(11) NULL DEFAULT 0 COMMENT '退货 换货地址id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '售后订单' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_order_share`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `type` int(11) NULL DEFAULT 0 COMMENT '类型 0--拼团 1--预约',
  `order_id` int(11) NULL DEFAULT NULL COMMENT '订单id',
  `parent_id_1` int(11) NULL DEFAULT 0 COMMENT '一级分销商id',
  `parent_id_2` int(11) NULL DEFAULT 0 COMMENT '二级分销商id',
  `parent_id_3` int(11) NULL DEFAULT 0 COMMENT '三级分销商id',
  `first_price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '一级分销佣金',
  `second_price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '二级分销佣金',
  `third_price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '三级分销佣金',
  `is_delete` int(11) NULL DEFAULT 0,
  `version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0',
  `rebate` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '自购返利',
  `user_id` int(11) NULL DEFAULT 0 COMMENT '下单用户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单分销数据' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_order_union`  (
  ...
  `store_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支付单号',
  `order_id_list` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单id列表',
  `price` decimal(10, 2) NOT NULL COMMENT '支付金额',
  `is_pay` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否已付款0=未付款，1=已付款',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单合并支付' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pond`  (
  ...
  `num` int(11) NULL DEFAULT 0 COMMENT '积分数量',
  `price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '红包价格',
  `image_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '图片',
  `stock` int(11) NOT NULL DEFAULT 0 COMMENT '库存',
  `orderby` int(11) NULL DEFAULT 0 COMMENT '排序',
  `coupon_id` int(11) NULL DEFAULT 0 COMMENT '优惠卷',
  `gift_id` int(11) NULL DEFAULT 0 COMMENT '赠品',
  `create_time` int(11) NOT NULL DEFAULT 0,
  `update_time` int(11) NOT NULL DEFAULT 0,
  `attr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '规格',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pond_log`  (
  ...
  `create_time` int(11) NOT NULL DEFAULT 0,
  `raffle_time` int(11) NULL DEFAULT 0 COMMENT '领取时间',
  `type` int(11) NOT NULL DEFAULT 0,
  `num` int(11) NULL DEFAULT 0,
  `gift_id` int(11) NULL DEFAULT 0,
  `coupon_id` int(11) NULL DEFAULT 0,
  `price` decimal(10, 2) NULL DEFAULT 0.00,
  `attr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
...
CREATE TABLE `hjmall_pond_setting`  (
  ...
  `rule` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '规则',
  `deplete_register` int(11) NULL DEFAULT 0 COMMENT '消耗积分',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_postage_rules`  (
  ...
  `type` smallint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '计费方式【1=>按重计费、2=>按件计费】',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '运费规则' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_printer`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '打印机名称',
  `printer_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '打印机类型',
  `printer_setting` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '打印机设置',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '小票打印机' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_printer_setting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `printer_id` int(11) NULL DEFAULT NULL COMMENT '打印机ID',
  `block_id` int(11) NULL DEFAULT NULL COMMENT '打印模板ID',
  `type` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '打印方式 ',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `is_attr` int(11) NULL DEFAULT 0 COMMENT '是否打印规格 0--不打印 1--打印',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '打印设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pt_cat`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题名称',
...
CREATE TABLE `hjmall_pt_goods`  (
  ...
  `attr` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '规格的库存及价格',
  `service` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '服务选项',
  `sort` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '商品排序 升序',
  `virtual_sales` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '虚拟销量',
  `cover_pic` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品缩略图',
  `weight` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '重量',
  `freight` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '运费模板ID',
  `unit` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '件' COMMENT '单位',
  `addtime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `is_delete` smallint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除',
  ...
  `limit_time` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '拼团限时',
...
CREATE TABLE `hjmall_pt_goods_detail`  (
  ...
  `store_id` int(11) NOT NULL,
  `goods_id` int(11) NULL DEFAULT NULL,
  `colonel` decimal(10, 2) UNSIGNED NULL DEFAULT 0.00 COMMENT '团长优惠',
  `group_num` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '商品成团数',
  `group_time` int(11) NULL DEFAULT NULL COMMENT '拼团时间/小时',
  `attr` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '规格的库存及价格',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pt_order`  (
  ...
  `colonel` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '团长优惠',
  `is_success` smallint(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否成团',
  `success_time` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '成团时间',
  `status` smallint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '拼团状态【1=> 待付款，2= 拼团中，3=拼团成功，4=拼团失败】',
  `is_returnd` smallint(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否退款',
  `is_cancel` smallint(1) NULL DEFAULT 0 COMMENT '是否取消',
  `limit_time` int(1) UNSIGNED NULL DEFAULT NULL COMMENT '拼团限时',
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备注',
  `words` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商家留言',
  `shop_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '自提店铺',
  `offline` smallint(1) UNSIGNED NULL DEFAULT 1 COMMENT '拿货方式',
  `clerk_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '核销员ID',
  `is_price` smallint(1) NULL DEFAULT 0 COMMENT '是否发放佣金',
  `express_price_1` decimal(10, 2) NULL DEFAULT NULL COMMENT '减免的运费',
  `class_group` int(11) NULL DEFAULT 0 COMMENT '阶级团',
  `is_recycle` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否加入回收站 0--不加入 1--加入',
  `is_show` smallint(1) NOT NULL DEFAULT 1 COMMENT '是否显示 0--不显示 1--显示（软删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pt_order_comment`  (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_virtual` smallint(6) NULL DEFAULT 0,
  `virtual_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `virtual_avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pt_order_refund`  (
  ...
  `response_time` int(11) NOT NULL DEFAULT 0 COMMENT '商家处理时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '拼团订单售后表' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pt_robot`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '机器人名',
  `pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '头像',
  `is_delete` smallint(1) UNSIGNED NULL DEFAULT NULL COMMENT '是否删除',
  `addtime` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '添加时间',
  `store_id` int(11) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '拼团机器人表' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_pt_setting`  (
  ...
  `is_print` int(11) NULL DEFAULT 0 COMMENT '是否开启订单打印',
  `is_mail` int(11) NULL DEFAULT 0 COMMENT '是否开启邮件通知',
  `is_area` tinyint(1) NULL DEFAULT NULL COMMENT '区域限制  0--关闭 1--开启',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '拼团设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_qrcode`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  `qrcode_bg` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '背景图片',
  `avatar_size` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '头像大小{\"w\":\"\",\"h\":\"\"}',
  `avatar_position` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '头像坐标{\"x\":\"\",\"y\":\"\"}',
  `qrcode_size` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码宽度',
  `qrcode_position` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '二维码坐标{\"x\":\"\",\"y\":\"\"}',
  `font_position` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字体坐标{\"x\":\"\",\"y\":\"\"}',
  `font` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字体设置\r\n{\r\n  \"size\":大小,\r\n  \"color\":\"r,g,b\"\r\n}',
  `preview` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '预览图',
  `is_delete` int(11) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '海报图的设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_re_order`  (
  ...
  `user_id` int(11) NULL DEFAULT NULL COMMENT '用户',
  `pay_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '支付金额',
  `send_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '赠送金额',
  `pay_type` int(11) NULL DEFAULT 0 COMMENT '支付方式 1--微信支付',
  `is_pay` int(11) NULL DEFAULT 0 COMMENT '是否支付 0--未支付 1--支付',
  `pay_time` int(11) NULL DEFAULT NULL COMMENT '支付时间',
  `is_delete` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `hjmall_recharge`  (
  ...
  `store_id` int(11) NULL DEFAULT NULL,
  `pay_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '支付金额',
  `send_price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '赠送金额',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充值名称',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '充值管理' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_refund_address`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL DEFAULT 0,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '收件人名称',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '收件人地址',
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '收件人电话',
...
CREATE TABLE `hjmall_register`  (
  ...
  `store_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `register_time` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `addtime` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `hjmall_scratch_setting`  (
  ...
  `end_time` int(11) NOT NULL DEFAULT 0 COMMENT '结束时间',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '小程序标题',
  `rule` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '规则说明',
  `deplete_register` int(11) NULL DEFAULT 0 COMMENT '消耗积分',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_sender`  (
  ...
  `exp_area` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `hjmall_setting`  (
  ...
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '分销佣金 的 用户须知',
  ...
  `agree` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '分销协议',
  `first_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `second_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `third_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pic_url_1` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `pic_url_2` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `price_type` int(11) NULL DEFAULT 0 COMMENT '分销金额 0--百分比金额  1--固定金额',
  `bank` tinyint(4) NULL DEFAULT NULL COMMENT '银行卡支付  0 --不使用  1--使用',
  `remaining_sum` tinyint(1) NULL DEFAULT 0 COMMENT '余额提现 0=关闭 1=开启',
  `rebate` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '自购返利',
  `is_rebate` int(11) NULL DEFAULT 0 COMMENT '是否开启自购返利',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分销商佣金设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_share`  (
  ...
  `seller_comments` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商家备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分销商' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_shop`  (
  ...
  `addtime` int(11) NULL DEFAULT NULL,
  `longitude` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `latitude` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `score` int(11) NULL DEFAULT 5 COMMENT '评分 1~5',
  `cover_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '门店大图',
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '门店小图',
  `shop_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '营业时间',
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '门店介绍',
  `is_default` int(11) NULL DEFAULT 0 COMMENT '是否设为默认 0--否 1--是 （只能设置一个门店为默认门店）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门店设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_sms_record`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tpl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `hjmall_sms_setting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NULL DEFAULT NULL,
  `AccessKeyId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '阿里云AccessKeyId',
  `AccessKeySecret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '阿里云AccessKeySecret',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信模板名称',
  `sign` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信模板签名',
  `tpl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信模板code',
  `msg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信模板参数',
  `status` smallint(6) NOT NULL DEFAULT 0 COMMENT '开启状态 0--关闭 1--开启',
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `is_delete` smallint(6) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  `tpl_refund` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '退款模板参数',
  `tpl_code` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '验证码模板参数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '短信设置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_store`  (
  ...
  `order_send_tpl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '发货通知模板消息id',
  `contact_tel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '联系电话',
  ...
  `copyright_pic_url` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `copyright_url` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '版权的超链接',
  ...
  `kdniao_mch_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '快递鸟商户号',
  `kdniao_api_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '快递鸟api key',
  `cat_style` smallint(6) NOT NULL DEFAULT 1 COMMENT '分类页面样式：1=无侧栏，2=有侧栏',
  `home_page_module` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '首页模块布局',
  `address` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '店铺地址',
  ...
  `is_coupon` smallint(6) NULL DEFAULT 0 COMMENT '是否开启优惠券',
  ...
  `member_content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '会员等级说明',
  `nav_count` int(11) NULL DEFAULT 0 COMMENT '首页导航栏个数 0--4个 1--5个',
  `integral` int(11) UNSIGNED NOT NULL DEFAULT 10 COMMENT '一元抵多少积分',
  `integration` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '积分使用说明',
  `dial` smallint(1) NULL DEFAULT NULL COMMENT '一键拨号开关  0关闭  1开启',
  `dial_pic` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '拨号图标',
  `cut_thread` smallint(1) NULL DEFAULT NULL COMMENT '分类分割线   0关闭   1开启',
  `purchase_frame` smallint(1) NULL DEFAULT 0,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_topic`  (
  ...
  `store_id` int(11) NOT NULL,
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标题',
  `sub_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '副标题',
  `cover_pic` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '封面图片',
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '专题内容',
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(6) NOT NULL DEFAULT 0,
  `is_chosen` smallint(6) NULL DEFAULT NULL,
...
CREATE TABLE `hjmall_topic_favorite`  (
  ...
  `is_delete` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户收藏的专题' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_upload_config`  (
  ...
  `aliyun` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '阿里云oss配置，json格式',
  `qcloud` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '腾讯云cos配置，json格式',
  `qiniu` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '七牛云存储配置，json格式',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传方式配置' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_upload_file`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  `file_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '文件url',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `store_id`(`store_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户上传的文件' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_user`  (
  ...
  `binding` char(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '授权手机号',
  `wechat_platform_open_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '微信公众号openid',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `hjmall_user_account_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户账户余额变动记录' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户授权登录' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_user_card`  (
  ...
  `card_pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '卡券图片',
  `card_content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '卡券描述',
  `is_use` int(11) NULL DEFAULT NULL COMMENT '是否使用 0--未使用 1--已使用',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `clerk_id` int(11) NULL DEFAULT NULL COMMENT '核销人id',
  `shop_id` int(11) NULL DEFAULT NULL COMMENT '店铺ID',
  `clerk_time` int(11) NULL DEFAULT NULL COMMENT ' 核销时间',
...
CREATE TABLE `hjmall_user_coupon`  (
  ...
  `is_delete` smallint(6) NOT NULL DEFAULT 0,
  `addtime` int(11) NOT NULL DEFAULT 0,
  `type` smallint(6) NULL DEFAULT 0 COMMENT '领取类型 0--平台发放 1--自动发放 2--领券中心领取',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户-优惠券关系' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_user_form_id`  (
  ...
  `addtime` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户FormId记录' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_user_share_money`  (
  ...
  `order_id` int(11) NULL DEFAULT NULL COMMENT '订单ID',
  `user_id` int(11) NULL DEFAULT NULL COMMENT '用户ID',
  `type` int(11) NULL DEFAULT NULL COMMENT '类型 0--佣金 1--提现',
  `source` int(11) NULL DEFAULT 1 COMMENT '佣金来源 1--一级分销 2--二级分销 3--三级分销',
  `money` decimal(10, 2) NULL DEFAULT NULL COMMENT '金额',
  `is_delete` int(11) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `order_type` int(11) NULL DEFAULT 0 COMMENT '订单类型 0--商城订单 1--秒杀订单 2--拼团订单 3--预约订单',
  `version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '版本',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户佣金明细表' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_video`  (
  ...
  `url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '路径',
  `sort` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '排序  升序',
  `is_delete` smallint(6) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `store_id` int(11) NULL DEFAULT NULL COMMENT '商城id',
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '详情介绍',
  `type` int(11) NULL DEFAULT 0 COMMENT '视频来源 0--源地址 1--腾讯视频',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_we7_user_auth`  (
  ...
  `auth` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_wechat_app`  (
  ...
  `cert_pem` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `key_pem` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信小程序' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_wechat_platform`  (
  ...
  `acid` int(11) NOT NULL DEFAULT 0 COMMENT '微擎公众号id',
  `user_id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公众号名称',
  `app_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公众号appid',
  `app_secret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公众号appsecret',
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公共号说明、备注',
  `mch_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信支付商户号',
  `key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信支付key',
  `cert_pem` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '微信支付cert文件内容',
  `key_pem` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '微信支付key文件内容',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `hjmall_wx_title`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `url` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '小程序页面路径',
  `store_id` int(11) NULL DEFAULT NULL COMMENT '商城ID',
  `title` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '默认标题' COMMENT '小程序页面标题',
  `addtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_yy_cat`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题名称',
  `store_id` int(11) UNSIGNED NOT NULL COMMENT '商城ID',
  `pic_url` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '分类图片url',
  `sort` int(11) NOT NULL DEFAULT 100 COMMENT '排序 升序',
  `addtime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  `is_delete` smallint(1) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商城预约' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_yy_form`  (
  ...
  `required` int(1) UNSIGNED NULL DEFAULT NULL COMMENT '是否必填',
  `default` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '默认值',
  `tip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提示语',
  `sort` int(11) NULL DEFAULT NULL,
  `is_delete` int(1) NULL DEFAULT NULL,
  `addtime` int(11) NULL DEFAULT NULL,
  `option` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '单选、复选项 值',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '预约自定义表单' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_yy_goods`  (
  ...
  `original_price` decimal(10, 2) UNSIGNED NOT NULL COMMENT '原价',
  `detail` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品详情，图文',
  `cat_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '商品分类',
  `status` smallint(6) UNSIGNED NOT NULL DEFAULT 2 COMMENT '上架状态【1=> 上架，2=> 下架】',
  `service` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '服务选项',
  `sort` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '商品排序 升序',
  `virtual_sales` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '虚拟销量',
  `cover_pic` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品缩略图',
  `addtime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  ...
  `shop_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '门店id',
  `store_id` int(11) UNSIGNED NOT NULL,
...
CREATE TABLE `hjmall_yy_order`  (
  ...
  `pay_type` smallint(6) UNSIGNED NULL DEFAULT 0 COMMENT '支付方式：1=微信支付',
  `pay_time` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '支付时间',
  `is_use` smallint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否使用',
  `is_comment` int(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否评论',
  `apply_delete` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否申请取消订单：0=否，1=申请取消订单',
  `addtime` int(11) NOT NULL DEFAULT 0,
  `is_delete` smallint(1) NOT NULL DEFAULT 0,
  `offline_qrcode` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '核销码',
  ...
  `store_id` int(11) UNSIGNED NOT NULL,
  `use_time` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '核销时间',
  `clerk_id` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '核销员user_id',
  `shop_id` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '自提门店ID',
  `is_refund` smallint(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否取消',
  `form_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '表单ID',
  `refund_time` int(11) NULL DEFAULT 0 COMMENT '取消时间',
  `is_recycle` smallint(1) NOT NULL DEFAULT 0 COMMENT '是否加入回收站 0--不加入 1--加入',
  `is_show` smallint(1) NOT NULL DEFAULT 1 COMMENT '是否显示 0--不显示 1--显示（软删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '预约订单表' ROW_FORMAT = Compact;
...
CREATE TABLE `hjmall_yy_order_form`  (
  ...
  `is_delete` int(11) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `hjmall_yy_setting`  (
  ...
  `success_notice` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '预约成功模板通知',
  `refund_notice` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '退款模板id',
  `is_share` int(11) NULL DEFAULT 0 COMMENT '是否开启分销 0--关闭 1--开启',
  `is_sms` int(11) NULL DEFAULT 0 COMMENT '是否开启短信通知',
  `is_print` int(11) NULL DEFAULT 0 COMMENT '是否开启订单打印',
  `is_mail` int(11) NULL DEFAULT 0 COMMENT '是否开启邮件通知',
...
ALTER TABLE `hjmall_user` ADD COLUMN `platform` tinyint NOT NULL DEFAULT '0' COMMENT '小程序平台 0 => 微信, 1 => 支付宝';
